...
/****************Libraries******************************/
/* Libraries needed for MiWi are (These are in main.h):
 * #include "stm32f4xx.h"
...
/****************Defines********************************/
#define P_RESET_MRF	GPIOB
#define RESET_MRF	GPIO_Pin_13
#define P_WAKE_MRF	GPIOC
#define WAKE_MRF	GPIO_Pin_5
#define P_CS_MRF	GPIOC
#define CS_MRF		GPIO_Pin_6
#define P_INT_MRF	GPIOC
#define INT_MRF		GPIO_Pin_4
